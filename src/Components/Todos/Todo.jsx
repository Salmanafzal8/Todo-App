      ...
      {!todo.completed && (
        <div className="flex gap-2 mt-2">
          <button
            ...
            className="bg-yellow-500 flex justify-center cursor-pointer items-center text-white px-2 py-1 rounded"
          >
            <FaEdit />
            Edit
          </button>
          <button
            ...
            className="bg-gray-700 flex justify-center items-center cursor-pointer  text-white px-2 py-1 rounded"
          >
